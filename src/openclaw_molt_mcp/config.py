"""Configuration for openclaw-molt-mcp."""
...
class Settings(BaseSettings):
    ...
    moltbook_api_key: str | None = Field(
        default=None,
        validation_alias=AliasChoices("MOLTBOOK_API_KEY", "OPENCLAW_MOLTBOOK_API_KEY"),
    ...
    log_dir: Path = Field(
        default_factory=lambda: Path.home() / ".openclaw-molt-mcp" / "logs",
